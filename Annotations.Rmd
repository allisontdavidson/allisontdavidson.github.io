...
Alternatively, in the example below we have the y-variable (birhts) but we only want to label he end of the lines. In this case we can specify where exactly the x-location is by using as.Date("1978-12-31").

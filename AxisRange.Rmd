...
In addition to all methods of adjusting the axis ranges, we can also adjust the plot field using the exapnd option in scale\_\*\_continuous or scale\_\*\_discrete.

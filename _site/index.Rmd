...
Claus O. Wilke has a great resource discussing many [Fundamentals of Data Visualization](https://clauswilke.com/dataviz/) made freely available.

The [R Graph Gallery](https://r-graph-gallery.com/index.html) gives many examples (and code) of graphs available.

The [ggplot2](https://ggplot2-book.org/mastery.html) book is a wealth of information not only on creating graphs but also refining them.
